...
mnist = read_data_sets("sports_data/", one_hot=True)
...
train_img, train_lbl = loadmnist('sports-data-unzip/train-images-idx3-ubyte'
                                 , 'sports-data-unzip/train-labels-idx1-ubyte')
test_img, test_lbl = loadmnist('sports-data-unzip/test-images-idx3-ubyte'
                               , 'sports-data-unzip/test-labels-idx1-ubyte')
...
linReg.predict(test_img)


acc1 = linReg.score(test_img,test_lbl)


print("\nlinear regression accuracy: "+str(acc1))
...
# Plot outputs
# plt.scatter(test_img, test_lbl,  color='black')
# plt.plot(test_img, test_lbl, color='blue', linewidth=3)